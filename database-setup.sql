-- =============================================================================
-- DISRUPTORS AI MARKETING HUB - COMPLETE DATABASE SCHEMA
-- =============================================================================
-- This file contains the complete database setup for the Disruptors AI Marketing Hub
...
CREATE INDEX IF NOT EXISTS idx_team_members_active ON team_members(is_active, order_index);
CREATE INDEX IF NOT EXISTS idx_case_studies_published ON case_studies(is_published, is_featured, order_index);
CREATE INDEX IF NOT EXISTS idx_blog_posts_published ON blog_posts(is_published, published_at DESC);
CREATE INDEX IF NOT EXISTS idx_blog_posts_category ON blog_posts(category);
CREATE INDEX IF NOT EXISTS idx_resources_published ON resources(is_published, resource_type, order_index);
CREATE INDEX IF NOT EXISTS idx_services_active ON services(is_active, is_featured, order_index);
CREATE INDEX IF NOT EXISTS idx_testimonials_published ON testimonials(is_published, is_featured);

-- AI Generation indexes
CREATE INDEX IF NOT EXISTS idx_generated_media_service ON generated_media(generation_service, media_type);
CREATE INDEX IF NOT EXISTS idx_generated_media_created ON generated_media(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_generated_media_approved ON generated_media(is_approved, is_public);
CREATE INDEX IF NOT EXISTS idx_generation_analytics_date ON generation_analytics(date DESC);
...
CREATE INDEX IF NOT EXISTS idx_assessment_responses_created ON assessment_responses(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_strategy_bookings_status ON strategy_session_bookings(booking_status, preferred_date);
...
-- Success message
SELECT 'Database setup completed successfully! All tables, indexes, RLS policies, and functions have been created.' as setup_status;